...
public class BeanFile {
    ...
    public String toString() {
        ...
        List<ColumnProperties> columnPropertiesList = new ArrayList<ColumnProperties>();
        ...
        headData.append("\r\n");
        headData.append("/**\n");
        headData.append(" * " + comment + "\n");
        headData.append(" * Created by " + Config.optName + " on " + DateFormatUtils.format(new Date(), "yyyy-MM-dd") + ".\n");
        headData.append(" */\n");
        data.append("}");
